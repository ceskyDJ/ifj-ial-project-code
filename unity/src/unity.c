...
const char PROGMEM UnityStrFinalOk[]                       = "\033[42mOK\033[00m";
const char PROGMEM UnityStrFinalFail[]                     = "\033[41mFAILED\033[00m";
...
#else
const char PROGMEM UnityStrFinalOk[]                       = "OK";
const char PROGMEM UnityStrFinalFail[]                     = "FAILED";
...
int UnityEnd(void)
{
    ...
    {
        UnityPrint(UnityStrFinalOk);
    }
    else
    {
        UnityPrint(UnityStrFinalFail);
